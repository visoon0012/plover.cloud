...
env.passwords = {
    'root@149.28.172.147:22': 'A]q2u4)}_9tKcyBP',
}
"""
1、初始化
...
def start():
    with settings(warn_only=True):
        ...
        run('sudo docker run -d --privileged --link shadowsocks:myhost -e TARGET_HOST=myhost -e TARGET_PORT=38378 -p 8888:8888 --name lkl wuqz/lkl:latest')
    print('更新完毕')
