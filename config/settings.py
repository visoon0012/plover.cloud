...
# 定时任务
CRONJOBS = [
    ('0 1 * * *', 'app_spider.utils.get_resource_urls', '>>CRONJOBS.log'),
    ('0 2 * * *', 'app_spider.utils.get_resources', '>>CRONJOBS.log'),
    ('0 3 * * *', 'app_movie.utils.auto_get_movie_simple', '>>CRONJOBS.log'),
